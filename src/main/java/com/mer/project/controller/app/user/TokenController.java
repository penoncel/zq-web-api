...
@Validated
@RestController
@RequestMapping(value = "/app/authentication",produces = MediaType.APPLICATION_JSON_VALUE)
...
public class TokenController {
    ...
    public Result refreshToken(@RequestParam  @ApiParam(value = "token", required = true) @NotEmpty(message = "authorization不能为空(refreshToken)")String token){
